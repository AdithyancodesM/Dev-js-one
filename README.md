# Dev-js-one
 This repository contains solutions to basic problems solved using *JavaScript*.

---

## 1)Fibonacci Series
  This program prints the fibonacci series upto the 'n' numbers.
...
This program calculaates the sum of digits of a given number.
